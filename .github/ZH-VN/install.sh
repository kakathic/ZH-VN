...
#[ -e "$VHMI/color/Tối.ini" ] || cp -f $TMPDIR/*.ini $VHMI/color
Xu_install 7za >&2
Xu_install jre
...
Autoone "Lmiui/os/Build;->IS_STABLE_VERSION:Z" "0x1" "com.miui.powerkeeper/classes*/*"
Autoone "Lmiui/os/Build;->IS_INTERNATIONAL_BUILD:Z" "0x1" "com.miui.powerkeeper/classes*/*"
Thaythe "ro.product.mod_device" "ro.product.vip" "com.miui.powerkeeper/classes*/*"
