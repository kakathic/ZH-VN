...
if [ -z "$(pm path "com.google.android.gms")" ] || [ ! -e $MODPATH/system/product/priv-app/GmsCore/GmsCore.apk ];then
echo > $MODPATH/NO
...
if [ -z "$(pm path "com.google.android.inputmethod.latin")" ] || [ ! -e $MODPATH/system/product/priv-app/Gboard/Gboard.apk ];then
